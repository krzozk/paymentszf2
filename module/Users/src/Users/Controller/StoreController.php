...
class StoreController extends AbstractActionController
{
    ...
    public function paypalExpressCheckoutAction()
    {
    	...
    	$express->setReturnUrl('http://paymentszf2.local/users/store/paymentConfirm');
    	$express->setCancelUrl('http://paymentszf2.local/users/store/paymentCancel');
    ...
    protected function getPaypalRequest()
    {
        ...
        $paypalConfig->setUsername('osirk.ruiz-facilitator_api1.globallynx.com');
        $paypalConfig->setPassword('1382120711');
        $paypalConfig->setSignature('AeU43bRmnTetE4g4TfmtsXaRJSWtAiWMnJzm.6HQ1r8TLa2jTkYOzHn-');
